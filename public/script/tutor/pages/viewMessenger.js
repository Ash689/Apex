            ...
            messengers.forEach(messenger => {
                ...
                if (messenger.mostRecentMessage.includes("Lesson Report") &&
                    ...
                    messengerElement.innerHTML = `
                        <img id="P1" style = "width: 200px" alt="${messenger.originalname}" src="/uploads/profileFiles/student/profilePicture/${messenger.filename}" alt="Profile Image">
